...
#| include: false
# data prep
CENSUS = st_read("/media/rosa/Dados/GIS/MQAT/original/BGRI21_LISBOA.gpkg")
CENSUS = CENSUS |> 
...
CENSUS = CENSUS |> left_join(Municipalities_names |> select(Mun_code, Municipality) |> distinct()) |> 
  select(Municipality, UID, Population, Buildings)
st_write(CENSUS, "../data/census.gpkg", delete_dsn = TRUE)
```
...
#| include: false
#| eval: false
st_write(Centroid_pop, "../data/Centroid_pop.gpkg", delete_dsn = TRUE)
```
