...
# piggyback::pb_upload("original/routes_car.geojson")
# piggyback::pb_upload("original/routes_foot.geojson")
# piggyback::pb_upload("original/routes_bike.geojson")

SURVEYcar = st_read("https://github.com/U-Shift/MQAT/releases/download/2025/routes_car.geojson", quiet = TRUE)
